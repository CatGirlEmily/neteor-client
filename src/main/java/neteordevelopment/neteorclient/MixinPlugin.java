...
import neteordevelopment.neteorclient.asm.Asm;
...
public class MixinPlugin implements IMixinConfigPlugin {
    private static final String mixinPackage = "neteordevelopment.neteorclient.mixin";
    ...
    public void onLoad(String mixinPackage) {
        ...
        try {
            ...
            NeteorClient.LOG.error("Error loading the mixin plugin", e);
        }
