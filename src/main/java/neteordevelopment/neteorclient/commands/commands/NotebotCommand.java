...
import neteordevelopment.neteorclient.commands.arguments.NotebotSongArgumentType;
...
public class NotebotCommand extends Command {
    ...
    public void build(LiteralArgumentBuilder<CommandSource> builder) {
        builder.then(literal("help").executes(ctx -> {
            Util.getOperatingSystem().open("https://github.com/NeteorDevelopment/neteor-client/wiki/Notebot-Guide");
        ...
        builder.then(literal("record").then(literal("save").then(argument("name", StringArgumentType.greedyString()).executes(ctx -> {
            ...
            Path notebotFolder = NeteorClient.FOLDER.toPath().resolve("notebot");
