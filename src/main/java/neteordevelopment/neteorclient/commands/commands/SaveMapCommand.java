...
import neteordevelopment.neteorclient.mixin.MapTextureManagerAccessor;
...
public class SaveMapCommand extends Command {
    ...
    private void saveMap(int scale) throws CommandSyntaxException {
        ...
        MapTextureManager.MapTexture texture = textureManager.neteor$invokeGetMapTexture(map.get(DataComponentTypes.MAP_ID), state);
        ...
        try {
            ...
            NeteorClient.LOG.error(e.toString());
        }
    }
