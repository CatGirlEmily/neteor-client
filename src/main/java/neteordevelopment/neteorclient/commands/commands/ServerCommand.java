    ...
    private void onReadPacket(PacketEvent.Receive event) {
        ...
        if (event.packet instanceof CommandTreeS2CPacket packet) {
            ...
            packet.getCommandTree(
                CommandRegistryAccess.of(handler.neteor$getCombinedDynamicRegistries(), handler.neteor$getEnabledFeatures()),
                ClientPlayNetworkHandlerAccessor.neteor$getCommandNodeFactory()
