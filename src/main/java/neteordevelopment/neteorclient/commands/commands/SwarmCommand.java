...
import neteordevelopment.neteorclient.systems.modules.misc.swarm.SwarmConnection;
import neteordevelopment.neteorclient.systems.modules.misc.swarm.SwarmWorker;
import neteordevelopment.neteorclient.systems.modules.world.InfinityMiner;
                        ...
                        .then(argument("port", IntegerArgumentType.integer(0, 65535))
                                .executes(context -> {
                                    ...
                                    info(Text.literal("Click here to confirm").setStyle(Style.EMPTY
                                        ...
                                        .withClickEvent(new NeteorClickEvent(".swarm join confirm"))
                                    ));
