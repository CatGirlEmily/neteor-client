...
import neteordevelopment.neteorclient.gui.renderer.operations.TextOperation;
import neteordevelopment.neteorclient.gui.renderer.packer.GuiTexture;
import neteordevelopment.neteorclient.gui.renderer.packer.TexturePacker;
import neteordevelopment.neteorclient.gui.widgets.WWidget;
import neteordevelopment.neteorclient.renderer.Renderer2D;
...
import static neteordevelopment.neteorclient.utils.Utils.getWindowHeight;
import static neteordevelopment.neteorclient.utils.Utils.getWindowWidth;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(NeteorClient.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(NeteorClient.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(NeteorClient.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(NeteorClient.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(NeteorClient.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(NeteorClient.identifier("textures/icons/gui/favorite_yes.png"));

        COPY = addTexture(NeteorClient.identifier("textures/icons/gui/copy.png"));
        PASTE = addTexture(NeteorClient.identifier("textures/icons/gui/paste.png"));
