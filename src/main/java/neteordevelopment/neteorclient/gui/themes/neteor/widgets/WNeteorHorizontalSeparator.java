...
import neteordevelopment.neteorclient.gui.widgets.WHorizontalSeparator;

public class WNeteorHorizontalSeparator extends WHorizontalSeparator implements NeteorWidget {
    public WNeteorHorizontalSeparator(String text) {
        super(text);
    }
