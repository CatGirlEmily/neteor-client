...
package neteordevelopment.neteorclient.gui.themes.neteor.widgets.input;
...
import neteordevelopment.neteorclient.gui.themes.neteor.widgets.WNeteorLabel;
...
public class WNeteorTextBox extends WTextBox implements NeteorWidget {
    private boolean cursorVisible;
    private double cursorTimer;

    private double animProgress;

    public WNeteorTextBox(String text, String placeholder, CharFilter filter, Class<? extends Renderer> renderer) {
    ...
    private static class CompletionItem extends WNeteorLabel implements ICompletionItem {
