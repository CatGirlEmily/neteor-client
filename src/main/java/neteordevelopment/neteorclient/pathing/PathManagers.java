...
public class PathManagers {
    ...
    public static void init() {
        if (exists("neteordevelopment.voyager.PathManager")) {
            try {
                INSTANCE = (IPathManager) Class.forName("neteordevelopment.voyager.PathManager").getConstructor().newInstance();
        ...
        NeteorClient.LOG.info("Path Manager: {}", INSTANCE.getName());
    }
