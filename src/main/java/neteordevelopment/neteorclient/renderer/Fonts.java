...
import neteordevelopment.neteorclient.renderer.text.FontFace;
...
import neteordevelopment.neteorclient.utils.render.FontUtils;
...
public class Fonts {
    ...
    public static void refresh() {
        ...
        NeteorClient.LOG.info("Found {} font families.", FONT_FAMILIES.size());
    ...
    public static void load(FontFace fontFace) {
        ...
        try {
            ...
            NeteorClient.EVENT_BUS.post(CustomFontChangedEvent.get());
        }
        catch (Exception e) {
            ...
            NeteorClient.LOG.error("Failed to load font: {}", fontFace, e);
