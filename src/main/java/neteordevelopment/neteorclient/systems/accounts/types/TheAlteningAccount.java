...
public class TheAlteningAccount extends Account<TheAlteningAccount> implements TokenAccount {
    ...
    public boolean fetchInfo() {
        ...
        try {
            ...
            NeteorClient.LOG.error("Invalid TheAltening credentials.");
            return false;
        } catch (Exception e) {
            NeteorClient.LOG.error("Failed to fetch info for TheAltening account!");
            return false;
        }
    }
    ...
    public boolean login() {
        ...
        try {
            ...
            NeteorClient.LOG.error("Failed to login with TheAltening.");
            return false;
        }
    }
    ...
    private WaybackAuthLib getAuth() {
        ...
        auth.setPassword("Neteor on Crack!");
