...
import neteordevelopment.neteorclient.renderer.*;
import neteordevelopment.neteorclient.renderer.text.CustomTextRenderer;
import neteordevelopment.neteorclient.renderer.text.Font;
import neteordevelopment.neteorclient.renderer.text.VanillaTextRenderer;
...
public class HudRenderer {
            ...
            for (Iterator<FontHolder> it = fontsInUse.values().iterator(); it.hasNext(); ) {
                ...
                if (fontHolder.visited) {
                    MeshRenderer.begin()
                        ...
                        .pipeline(NeteorRenderPipelines.UI_TEXT)
    ...
    private static class FontHolder {
        ...
        public MeshBuilder getMesh() {
            if (mesh == null) mesh = new MeshBuilder(NeteorRenderPipelines.UI_TEXT);
