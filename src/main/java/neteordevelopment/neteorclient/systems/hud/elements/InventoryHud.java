...
import neteordevelopment.neteorclient.systems.hud.HudRenderer;
...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = NeteorClient.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = NeteorClient.identifier("textures/container-transparent.png");
