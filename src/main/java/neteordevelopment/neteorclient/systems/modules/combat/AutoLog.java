...
import neteordevelopment.neteorclient.systems.modules.misc.AutoReconnect;
...
public class AutoLog extends Module {
    ...
    private void enableHealthListener() {
        NeteorClient.EVENT_BUS.subscribe(staticListener);
    }

    private void disableHealthListener() {
        NeteorClient.EVENT_BUS.unsubscribe(staticListener);
    }
}
