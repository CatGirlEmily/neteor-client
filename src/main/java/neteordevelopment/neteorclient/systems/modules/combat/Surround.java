...
import neteordevelopment.neteorclient.mixin.DirectionAccessor;
import neteordevelopment.neteorclient.mixin.WorldRendererAccessor;
...
public class Surround extends Module {
    ...
    private boolean place(BlockPos placePos, FindItemResult block) {
        ...
        for (BlockBreakingInfo value : ((WorldRendererAccessor) mc.worldRenderer).neteor$getBlockBreakingInfos().values()) {
