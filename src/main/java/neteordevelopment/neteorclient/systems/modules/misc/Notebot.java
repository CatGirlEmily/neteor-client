...
import neteordevelopment.neteorclient.utils.notebot.NotebotUtils;
import neteordevelopment.neteorclient.utils.notebot.decoder.SongDecoder;
import neteordevelopment.neteorclient.utils.notebot.decoder.SongDecoders;
import neteordevelopment.neteorclient.utils.notebot.instrumentdetect.InstrumentDetectMode;
import neteordevelopment.neteorclient.utils.notebot.song.Note;
import neteordevelopment.neteorclient.utils.notebot.song.Song;
...
public class Notebot extends Module {
    ...
    public void playRandomSong() {
        File[] files = NeteorClient.FOLDER.toPath().resolve("notebot").toFile().listFiles();
        ...
        loadingSongFuture.whenComplete((song ,ex) -> {
            if (ex == null) {
                ...
                if (ex instanceof CancellationException) {
                    ...
                    NeteorClient.LOG.error("An error occurred while loading song '{}'", FilenameUtils.getBaseName(file.getName()), ex);
                    onSongEnd();
                }
            }
        });
