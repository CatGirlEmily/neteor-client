...
package neteordevelopment.neteorclient.systems.modules.misc.swarm;
...
public class Swarm extends Module {
    ...
    public Swarm() {
        super(Categories.Misc, "swarm", "Allows you to control multiple instances of Neteor from one central host.");
    }
    ...
    public WWidget getWidget(GuiTheme theme) {
        ...
        guide.action = () -> Util.getOperatingSystem().open("https://github.com/NeteorDevelopment/neteor-client/wiki/Swarm-Guide");
