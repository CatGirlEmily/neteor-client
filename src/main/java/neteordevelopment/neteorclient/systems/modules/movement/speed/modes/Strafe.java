...
package neteordevelopment.neteorclient.systems.modules.movement.speed.modes;
...
import neteordevelopment.neteorclient.systems.modules.movement.Anchor;
import neteordevelopment.neteorclient.systems.modules.movement.speed.SpeedMode;
import neteordevelopment.neteorclient.systems.modules.movement.speed.SpeedModes;
    ...
    public void onMove(PlayerMoveEvent event) {
        switch (stage) {
            ...
            case 1: //Jump
                ...
                ((IVec3d) event.movement).neteor$setY(getHop(0.40123128));
        ...
        ((IVec3d) event.movement).neteor$setXZ(change.x, change.y);
    }
