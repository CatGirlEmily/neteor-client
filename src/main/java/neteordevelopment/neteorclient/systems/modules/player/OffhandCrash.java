...
import neteordevelopment.neteorclient.mixin.ClientConnectionAccessor;
...
public class OffhandCrash extends Module {
    ...
    private void onTick(TickEvent.Post event) {
        ...
        Channel channel = ((ClientConnectionAccessor) mc.player.networkHandler.getConnection()).neteor$getChannel();
