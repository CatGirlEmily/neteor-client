...
import neteordevelopment.neteorclient.events.game.ItemStackTooltipEvent;
import neteordevelopment.neteorclient.events.render.TooltipDataEvent;
import neteordevelopment.neteorclient.gui.screens.ContainerInventoryScreen;
import neteordevelopment.neteorclient.mixin.EntityAccessor;
import neteordevelopment.neteorclient.mixin.EntityBucketItemAccessor;
...
import neteordevelopment.neteorclient.utils.misc.ByteCountDataOutput;
...
import neteordevelopment.neteorclient.utils.tooltip.*;
...
public class BetterTooltips extends Module {
    ...
    private void getTooltipData(TooltipDataEvent event) {
        ...
        // Fish peek
            ...
            EntityType<?> type = ((EntityBucketItemAccessor) bucketItem).neteor$getEntityType();
            ...
            if (entity != null) {
                ...
                ((EntityAccessor) entity).neteor$setInWater(true);
