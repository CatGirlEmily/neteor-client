...
import neteordevelopment.neteorclient.utils.render.MeshBuilderVertexConsumerProvider;
import neteordevelopment.neteorclient.utils.render.RenderUtils;
import neteordevelopment.neteorclient.utils.render.SimpleBlockRenderer;
...
public class StorageESP extends Module {
    ...
    public StorageESP() {
        ...
        mesh = new MeshBuilder(NeteorRenderPipelines.WORLD_COLORED);
    ...
    private void onRender(Render3DEvent event) {
        ...
        if (mode.get() == Mode.Shader && count > 0) {
            MeshRenderer.begin()
                ...
                .pipeline(NeteorRenderPipelines.WORLD_COLORED)
