...
import neteordevelopment.neteorclient.mixin.AbstractSignEditScreenAccessor;
...
public class AutoSign extends Module {
    ...
    private void onOpenScreen(OpenScreenEvent event) {
        ...
        SignBlockEntity sign = ((AbstractSignEditScreenAccessor) event.screen).neteor$getSign();
