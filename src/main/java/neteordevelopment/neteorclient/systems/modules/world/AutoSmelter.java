...
import neteordevelopment.neteorclient.mixininterface.IAbstractFurnaceScreenHandler;
...
public class AutoSmelter extends Module {
    ...
    private void insertItems(AbstractFurnaceScreenHandler c) {
        ...
        for (int i = 3; i < c.slots.size(); i++) {
            ...
            if (!((IAbstractFurnaceScreenHandler) c).neteor$isItemSmeltable(item)) continue;
