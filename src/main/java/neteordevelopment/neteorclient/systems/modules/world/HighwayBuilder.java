...
import neteordevelopment.neteorclient.mixin.ShulkerBoxScreenHandlerAccessor;
...
import neteordevelopment.neteorclient.systems.modules.combat.KillAura;
import neteordevelopment.neteorclient.systems.modules.player.*;
import neteordevelopment.neteorclient.utils.Utils;
import neteordevelopment.neteorclient.utils.entity.SortPriority;
import neteordevelopment.neteorclient.utils.entity.TargetUtils;
import neteordevelopment.neteorclient.utils.misc.HorizontalDirection;
import neteordevelopment.neteorclient.utils.misc.MBlockPos;
import neteordevelopment.neteorclient.utils.player.*;
...
import neteordevelopment.neteorclient.utils.world.Dir;
...
public class HighwayBuilder extends Module {
    ...
    private enum State {
        ...
        Forward {
            ...
            private boolean isCrystalTrap(HighwayBuilder b) {
                for (Entity entity : b.mc.world.getEntities()) {
                    ...
                    ((IVec3d) vec1).neteor$set(b.mc.player.getX(), b.mc.player.getY() + b.mc.player.getStandingEyeHeight(), b.mc.player.getZ());
                    ((IVec3d) vec2).neteor$set(entity.getX(), entity.getY() + 0.5, entity.getZ());
                ...
                switch (blockState.getBlock()) {
                    ...
                    case ShulkerBoxBlock ignored -> {
                        if (b.mc.currentScreen instanceof ShulkerBoxScreen screen) {
                            ...
                            Inventory inv = ((ShulkerBoxScreenHandlerAccessor) screen.getScreenHandler()).neteor$getInventory();
        ...
        DefuseCrystalTraps {
             ...
             *
             * @see neteordevelopment.neteorclient.mixin.MinecraftClientMixin#wrapStopUsing(ClientPlayerInteractionManager, PlayerEntity)
             */
            @Override
            protected void tick(HighwayBuilder b) {
                if (cooldown > 0) {
