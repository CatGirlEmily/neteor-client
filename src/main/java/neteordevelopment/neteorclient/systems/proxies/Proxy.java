...
package neteordevelopment.neteorclient.systems.proxies;
...
public class Proxy implements ISerializable<Proxy> {
    ...
    // todo
    //  - add more rigorous status checks - perhaps querying our 'mcauth.neteorclient.com' or ccbluex's 'ping.liquidproxy.net'
