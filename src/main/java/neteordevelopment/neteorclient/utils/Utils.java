...
package neteordevelopment.neteorclient.utils;
...
import neteordevelopment.neteorclient.mixin.*;
...
import neteordevelopment.neteorclient.utils.world.BlockEntityIterator;
import neteordevelopment.neteorclient.utils.world.ChunkIterator;
...
public class Utils {
    ...
    private static final ProjectionMatrix2 matrix = new ProjectionMatrix2("neteor-projection-matrix", -10, 100, true);
    ...
    public static void init() {
        NeteorClient.EVENT_BUS.subscribe(Utils.class);
    }
    ...
    public static int getRenderDistance() {
        return Math.max(mc.options.getViewDistance().getValue(), ((ClientPlayNetworkHandlerAccessor) mc.getNetworkHandler()).neteor$getChunkLoadDistance());
    }
    ...
    public static void unscaledProjection() {
        ...
        RenderUtils.projection.set(((ProjectionMatrix2Accessor) matrix).neteor$callGetMatrix(width, height));
    ...
    public static void getItemsInContainerItem(ItemStack itemStack, ItemStack[] items) {
        ...
        if (components.contains(DataComponentTypes.CONTAINER)) {
            ...
            DefaultedList<ItemStack> stacks = container.neteor$getStacks();
    ...
    public static boolean hasItems(ItemStack itemStack) {
        ...
        if (container != null && !container.neteor$getStacks().isEmpty()) return true;
    ...
    public static String getWorldName() {
        ...
        if (mc.isInSingleplayer()) {
            ...
            File folder = ((MinecraftServerAccessor) mc.getServer()).neteor$getSession().getWorldDirectory(mc.world.getRegistryKey()).toFile();
    ...
    public static byte[] readBytes(InputStream in) {
        try {
            ...
            NeteorClient.LOG.error("Error reading from stream.", e);
            return new byte[0];
        } finally {
    ...
    public static void leftClick() {
        ...
        int attackCooldown = ((MinecraftClientAccessor) mc).neteor$getAttackCooldown();
        if (attackCooldown == 10000) {
            ((MinecraftClientAccessor) mc).neteor$setAttackCooldown(0);
        }

        mc.options.attackKey.setPressed(true);
        ((MinecraftClientAccessor) mc).neteor$leftClick();
        mc.options.attackKey.setPressed(false);
    }

    public static void rightClick() {
        ((IMinecraftClient) mc).neteor$rightClick();
    }
    ...
    public static boolean isLoading() {
        ResourceReloadLogger.ReloadState state = ((ResourceReloadLoggerAccessor) ((MinecraftClientAccessor) mc).neteor$getResourceReloadLogger()).neteor$getReloadState();
        return state == null || !((ReloadStateAccessor) state).neteor$isFinished();
    }
