...
import neteordevelopment.neteorclient.mixin.CrossbowItemAccessor;
import neteordevelopment.neteorclient.mixin.ProjectileInGroundAccessor;
...
public class ProjectileEntitySimulator {
    ...
    public boolean set(Entity user, ItemStack itemStack, double angleOffset, boolean accurate, float tickDelta) {
        ...
        switch (item) {
            ...
            case CrossbowItem ignored -> {
                ...
                float speed = CrossbowItemAccessor.neteor$getSpeed(projectilesComponent);
    ...
    public boolean set(Entity entity) {
        ...
        if (entity instanceof ProjectileInGroundAccessor ppe && ppe.neteor$invokeIsInGround()) return false;
    ...
    public SimulationStep tick() {
        age++;
        ((IVec3d) prevPos3d).neteor$set(pos);
    ...
    private SimulationStep getCollision() {
        ...
        if (blockCollision.getType() != HitResult.Type.MISS) {
            ((IVec3d) pos3d).neteor$set(blockCollision.getPos());
        }
