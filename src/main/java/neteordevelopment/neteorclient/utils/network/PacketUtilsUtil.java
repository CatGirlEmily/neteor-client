...
public class PacketUtilsUtil {
    ...
    public static void init() throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(file))) {
            writer.write("/*\n");
            writer.write(" * This file is part of the Neteor Client distribution (https://github.com/NeteorDevelopment/neteor-client/).\n");
            writer.write(" * Copyright (c) Neteor Development.\n");
            writer.write(" */\n\n");

            writer.write("package neteordevelopment.neteorclient.utils.network;\n\n");
