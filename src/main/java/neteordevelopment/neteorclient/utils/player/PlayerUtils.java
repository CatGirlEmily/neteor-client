...
import neteordevelopment.neteorclient.systems.modules.movement.NoFall;
...
import neteordevelopment.neteorclient.utils.misc.text.TextUtils;
...
import static neteordevelopment.neteorclient.utils.Utils.WHITE;
...
public class PlayerUtils {
    ...
    public static Vec3d getHorizontalVelocity(double bps) {
        ...
        ((IVec3d) horizontalVelocity).neteor$setXZ(velX, velZ);
    ...
    public static boolean canSeeEntity(Entity entity) {
        ...
        ((IVec3d) vec1).neteor$set(mc.player.getX(), mc.player.getY() + mc.player.getStandingEyeHeight(), mc.player.getZ());
        ((IVec3d) vec2).neteor$set(entity.getX(), entity.getY(), entity.getZ());
        ...
        ((IVec3d) vec2).neteor$set(entity.getX(), entity.getY() + entity.getStandingEyeHeight(), entity.getZ());
