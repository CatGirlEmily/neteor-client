...
import neteordevelopment.neteorclient.mixin.CreativeInventoryScreenAccessor;
import neteordevelopment.neteorclient.mixin.ItemGroupsAccessor;
import neteordevelopment.neteorclient.mixin.MountScreenHandlerAccessor;
...
public class SlotUtils {
    ...
    private static int creativeInventory(int i) {
        if (CreativeInventoryScreenAccessor.neteor$getSelectedTab() != Registries.ITEM_GROUP.get(ItemGroupsAccessor.neteor$getInventory()))
            return -1;
    ...
    private static int horse(ScreenHandler handler, int i) {
        LivingEntity entity = ((MountScreenHandlerAccessor) handler).neteor$getMount();
