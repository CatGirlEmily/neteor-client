...
package neteordevelopment.neteorclient.utils.world;

import neteordevelopment.neteorclient.mixin.ClientChunkManagerAccessor;
import neteordevelopment.neteorclient.mixin.ClientChunkMapAccessor;
...
public class ChunkIterator implements Iterator<Chunk> {
    private final ClientChunkMapAccessor map = (ClientChunkMapAccessor) (Object) ((ClientChunkManagerAccessor) mc.world.getChunkManager()).neteor$getChunks();
    ...
    private Chunk getNext() {
        ...
        while (i < map.neteor$getChunks().length()) {
            chunk = map.neteor$getChunks().get(i++);
